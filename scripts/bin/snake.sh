...
GAME_OVER[0]="\e[1;35mâ•¥â”Œ  â•“â”€â•– â•¥ â•¥ â•¥â”€â” â•¥â”€â”    â•¥ â•¥ â•¥â”  â•¥ â”¬\e[0m"
GAME_OVER[1]="\e[0;31mâ•Ÿâ”´â” â•‘ â•‘ â•‘\â•‘ â•Ÿâ”¤  â•‘      â•Ÿâ”€â•¢ â•Ÿâ”´â” â•¨â•¥â”˜\e[0m"
GAME_OVER[2]="\e[1;31mâ•¨ â”´ â•™â”€â•œ â•¨ â•¨ â•¨â”€â”˜ â•¨â”€â”˜    â•¨ â•¨ â•¨ â”´  â•¨ \e[0m"
GAME_OVER[3]="\e[0;32mâ•¥â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â•¥\e[0m"
GAME_OVER[4]="\e[1;32mâ•‘  Stiskni ENTER pro novou hru!  â•‘\e[0m"
GAME_OVER[5]="\e[1;36mâ•¨â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â•¨\e[0m"
...
function gen_food() {
    ...
    do
        ...
        FOOD["$y;$x"]=$food
        if [ $food -eq 1 ] ; then 
            printf "\e[$y;${x}f\e[1;32mâ™ \e[0m";
        else 
            printf "\e[$y;${x}f\e[1;31mâ™£\e[0m"; 
        fi
    done
}
...
# $1 width $2 height $3 content
    ...
    ul=$y";"$x
    bl=$[y+h+1]";"$x
    printf "\e[${ul}fâ”Œ"; printf 'â”€%.0s' $(eval echo {1..$w}); printf 'â”\n'
    for i in $(eval echo {0..$h}); 
    do 
        printf "\e[$[y+i+1];${x}fâ”‚";
        echo -en "$(eval printf \"%s\" \"\${$3[\$i]}\")"
        printf "\e[$[y+i+1];$[x+w+1]fâ”‚";
    done
    printf "\e[${bl}fâ””"; printf 'â”€%.0s' $(eval echo {1..$w}); printf 'â”˜\n'
}
...
function game_info() {
    printf "\e[$[MH+1];0fHrÃ¡Ä: $USER (NejlepÅ¡Ã­ vÃ½kon: $TOP_SCORE)"
    printf "\e[$[MH+1];$[MW-12]fSkÃ³re: %5d" $SCORE
}
